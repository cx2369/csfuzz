...
static void edit_params(u32 argc, char **argv)
{
  ...
  cc_params[cc_par_cnt++] = "-Xclang";
  cc_params[cc_par_cnt++] = alloc_printf("%s/afl-pass.so", obj_path);
#endif /* ^USE_TRACE_PC */
  ...
  //   for (int cxi = 0; cxi < cc_par_cnt; cxi++) {
  //   u8 *param = cc_params[cxi];
  //   printf("cc_params[%d]: ", cxi);
  //   printf("%s", (char*)param);
  //   printf("\n");
  // }
}
